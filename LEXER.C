...
/* Check for minimum required cmd line arguments */
	if (argc < 2)
		goto Usage;
...
/* Function fLoadTreeFromLogfile reads the logfile strLogFile to the btree pointed
...
*/
flag fLoadTreeFromLogFile(char *strLogFileName,Node **ppRootNode,LinkList **ppPathNames)
{
